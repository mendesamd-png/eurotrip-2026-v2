...
export const chapters: Chapter[] = [
  {
    ...
    paragraphs: [
      ...
      'Antes do embarque, o rito: a e-DBV na Receita Federal para provar que a Sony, as duas G Master, o drone e a Super 8 já eram meus antes de cruzarem o Atlântico. Sem isso, a volta vira interrogatório. Com isso, vira só um carimbo.',
  ...
  },
  {
    ...
    lead: 'Cinco noites em Westminster, um trabalho no meio e uma cidade que não está nem aí para a sua chegada. O que é ótimo.',
    paragraphs: [
      'Londres não está nem aí para a sua chegada. O que é ótimo. Você desce do metrô, erra uma saída, paga caro num café médio e, de repente, a luz bate numa esquina como se alguém tivesse montado o set sem avisar.',
  ...
  },
  {
    ...
    hero: 'birmingham',
    gallery: ['birmingham'],
    lead: 'Uma noite, um amigo, um sofá e duas caixas de encomendas esperando. Birmingham não é destino. É escala com afeto.',
    paragraphs: [
  ...
  },
  {
    ...
    lead: 'Cinco noites, um jogo, um show, um day trip a Liverpool e a cidade que não tenta agradar. Ainda bem.',
    paragraphs: [
      ...
      'A cidade podia ser fria, úmida, industrial e meio mal-humorada. Sorte que isso combina bastante com ela. Manchester não tenta vender sofisticação. Entrega tijolo, pub, chuva, música, curry barato e uma honestidade visual que Londres às vezes esconde atrás de fachada bonita.',
      ...
      'Aqui o plano é simples: futebol, música, cerveja e tijolo molhado. Às vezes uma cidade boa é só uma cidade que não tenta parecer outra coisa.',
    ],
  ...
  },
  {
    ...
    lead: 'Quando a viagem para de ser urbana e começa a cobrar panturrilha. Pico do Areeiro no escuro, Super 8 saindo da mochila.',
    paragraphs: [
      ...
      'Três dias com uma lista que parece simples até você lembrar que ilha tem microclima e estrada que muda de humor. Pico do Areeiro antes do nascer do sol, saindo de casa às quatro e meia. Ponta de São Lourenço na luz lateral de fim de tarde. Cabo Girão para o drone, onde a lei permitir e o vento não humilhar. Câmara de Lobos para o peixe, a Zona Velha para as portas pintadas e a poncha.',
      'A Super 8 sai aqui. Três rolos de Kodak Vision3 50D, uns dez minutos totais de filme bruto e uma cobrança por segundo que obriga a pensar antes de apertar o gatilho. Digital perdoa demais. Super 8 cobra na hora, mas só entrega a bronca seis semanas depois.',
    ...
    places: [
      ...
      { name: 'Cabo Girão', category: 'mirante', blurb: 'Skywalk de vidro numa das falésias mais altas da Europa. Spot de drone.', lat: 32.656, lng: -17.005 },
      ...
      { name: 'Eira do Serrado', category: 'mirante', blurb: 'Curral das Freiras visto de cima. Fica fora do drone: respeito também é direção.', lat: 32.7003, lng: -16.9583 },
    ],
    keywords: ['LEVADA', 'VULCÃO', 'MIRADOURO', 'ATLÂNTICO', 'PONCHA', 'AREEIRO', 'SUPER 8', 'SÃO LOURENÇO', 'CABO GIRÃO'],
    soundtrack: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Fanal é a cena principal da Super 8. Loureiros centenários no Paul da Serra, esperando a neblina aparecer para a floresta virar cenário de sonho caro feito com orçamento baixo. Trinta segundos, mão firme, sem zoom de tiozão. Se a neblina não vier, volta-se no dia seguinte. Se vier, é o tesouro.',
    ...
    places: [
      ...
      { name: 'Fanal', category: 'trilha', blurb: '36 min. Floresta de loureiros no Paul da Serra. Cena principal da Super 8. Ir cedo, esperar a neblina.', lat: 32.8125, lng: -17.1467, query: 'Fanal Madeira' },
    ...
    keywords: ['FANAL', 'NEBLINA', 'LAURISSILVA', 'SEIXAL', 'PORTO MONIZ', 'SANTANA', 'AREIA PRETA', 'SUPER 8', 'VOLTA'],
    soundtrack: [
      { title: 'Avril 14th', artist: 'Aphex Twin', reason: 'Neblina do Fanal, piano sozinho, mão firme na Super 8.' },
...
export const days: Day[] = [
  ...
  { n: 17, date: '2026-11-02', weekday: 'seg', chapter: 'funchal', city: 'Madeira', intensity: 'médio', title: 'São Lourenço · Cabo Girão', morning: 'Mercado dos Lavradores.', afternoon: 'Ponta de São Lourenço na luz lateral. Drone se o vento deixar.', night: 'Cabo Girão ao pôr do sol. Peixe em Câmara de Lobos.', status: 'esboço' },
  ...
  { n: 19, date: '2026-11-04', weekday: 'qua', chapter: 'ponta-delgada', city: 'Costa norte', intensity: 'pesado', title: '🎞️ Fanal', morning: 'Fanal cedo. Esperar a neblina. Super 8, três rolos.', afternoon: 'Porto Moniz, piscinas vulcânicas.', night: 'Santana. Última noite.', status: 'esboço' },
